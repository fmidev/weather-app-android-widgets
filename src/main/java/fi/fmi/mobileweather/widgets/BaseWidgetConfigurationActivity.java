...
import static fi.fmi.mobileweather.widgets.model.PrefKey.SELECTED_LOCATION;
import static fi.fmi.mobileweather.widgets.model.PrefKey.GRADIENT_BACKGROUND;
...
public abstract class BaseWidgetConfigurationActivity extends Activity {
    private static final String STATE_WAITING_FOR_APP_SETTINGS = "waiting_for_app_settings";
